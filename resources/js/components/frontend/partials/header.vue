<template>
	<header class="sg-header home-4 fixed-header"
		:class="{ 'sidebar-active': smCategory, 'mobile-menu-active': show_sm_home }">
		...
		<div class="sg-topbar d-none">
			<div class="container">
				<div class="custom-columns-container">
					<div class="custom-column-1">
						<router-link :to="{ name: 'home' }">
							<img :src="settings.dark_logo" alt="Logo" class="img-fluid ml-2" />
						</router-link>
						<div></div>
					</div>
		...
		<div :class="addons.includes('ishopet') ? toggleNavClass() : ''" id="middle_nav" class="header-middle header-menu">
			<div class="container">
				<div class="botom-content">
					<div class="sg-logo text-left">
						<div class="sg-categorie-menu categorie-lg align-self-lg-center">
							...
							<sidebar_categories v-if="addons.includes('ishopet')" ref="sidebar_category" :home="true">
							</sidebar_categories>
						</div>
						<div class="d-flex justify-content-between">
							<div class="mt-2" @click="toggleHeaderMenu">
								...
								<a v-else>
									<div class="icon"><img alt="Compare Icon" class="img-fluid" width="40px"
											:src="getUrl('public/images/others/arrowup.svg')" />
									</div>
								</a>
							</div>
							<router-link :to="{ name: 'home' }">
					...
					<div class="user-option d-flex justify-content-center">
						<ul class="global-list user-shop-option">
							...
							<li class="d-flex user-log-info">
								...
								<div v-else>
									<router-link class="d-block" :to="{ name: 'login' }">{{ lang.sign_in
									}}</router-link>
		...
		<div class="header-menu" :class="[toggleNavClass(), settings.header_theme]" id="nav" v-show="showHeaderMenu">
			<div class="container">
